...
|-----------|---------------------|------|
| `docker/eeg-mne-preprocessing` | `phindagijimana321/eeg-preprocessing-mne:1.0.0` | Filter, notch, reference |
...
| `docker/eeg-mne-source-localization` | `phindagijimana321/eeg-source-localization-mne:1.0.0` | dSPM inverse (needs `forward_solution.fif`) |
...
docker run --rm \
  ...
  phindagijimana321/eeg-preprocessing-mne:1.0.0
```
