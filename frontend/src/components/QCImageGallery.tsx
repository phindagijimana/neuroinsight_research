      ...
      {metrics && (
        <div className="bg-[#f0f4fa] border border-[#b3cce6] rounded-lg p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-navy-600">Hippocampal Sclerosis Analysis</h4>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-white rounded-md border border-[#d0dff0] p-3">
              ...
              <p className="text-lg font-bold text-navy-600">{metrics.volumes_mm3.left.toFixed(0)} mm³</p>
            </div>
            <div className="bg-white rounded-md border border-[#d0dff0] p-3">
              <p className="text-[10px] font-medium text-[#4a6fa5] tracking-wider">Right Hippocampus</p>
              <p className="text-lg font-bold text-navy-600">{metrics.volumes_mm3.right.toFixed(0)} mm³</p>
            </div>
            <div className="bg-white rounded-md border border-[#d0dff0] p-3">
              <p className="text-[10px] font-medium text-[#4a6fa5] tracking-wider">Asymmetry Index</p>
              <p className="text-lg font-bold text-navy-600">{metrics.asymmetry_index.toFixed(4)}</p>
            </div>
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="w-32 h-2 bg-[#b3cce6] rounded-lg appearance-none cursor-pointer accent-navy-600"
          />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
        {slices.map((sl) => (
          <button
            ...
            className="group relative rounded-lg overflow-hidden border-2 border-transparent hover:border-navy-600 transition-all focus:outline-none focus:ring-2 focus:ring-navy-600 focus:ring-offset-2"
          >
            {renderLayeredImage(sl, 'w-full h-auto object-contain block')}
            <div className="absolute inset-0 bg-navy-600/0 group-hover:bg-navy-600/10 transition-colors flex items-center justify-center pointer-events-none">
