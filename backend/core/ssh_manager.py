...
class SSHManager:
    ...
    def _idle_disconnect(self) -> None:
        ...
        try:
            ...
            logger.debug("Audit log unavailable during idle timeout: %s", e)
        self.disconnect()
    ...
    def _close_internal(self) -> None:
        ...
        if self._sftp:
            try:
                ...
                logger.debug("Error closing SFTP channel: %s", e)
            self._sftp = None
    ...
    def _mkdir_p(sftp: paramiko.SFTPClient, remote_dir: str) -> None:
        ...
        try:
            ...
            try:
                ...
                pass  # Directory may already exist (race condition / already created)
