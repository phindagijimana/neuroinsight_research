...
class Job(Base):
    ...
    data_source_platform = Column(String(50), nullable=True, comment="Source platform: pennsieve, xnat, or None for filesystem")
    data_source_dataset_id = Column(String(200), nullable=True, comment="Dataset/experiment ID on the source platform")
    ...
    def execution_mode(self) -> str:
        """Derive execution mode from stored parameters."""
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "data_source_platform": self.data_source_platform,
            "data_source_dataset_id": self.data_source_dataset_id,
        }
